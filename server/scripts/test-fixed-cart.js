...
console.log("Using fixed session ID:", FIXED_SESSION_ID);

// Create an axios instance with the fixed session ID
...
async function testFixedCart() {
  try {
    ...
    // Step 2: Get initial cart (should be empty or have existing items)
