...
const alienSeedData = [
  ...
  },
  {
    ...
    backstory:
      "Born in the scorched canyons of Yuldron, Gorrthak is one of the fiercest warriors of the Clawspike faction — a brutal brotherhood of lupine berserkers. His body is scorched with glowing magma veins, a sign of his pact with the Fire Titans of the Deep Core. Feared across the molten battlefields, Gorrthak seeks not conquest, but eternal combat to honor the fallen spirits of his kind.",
    abilities: ["Volcanic Roar", "Emberclaw Swipe"],
  ...
  },
  {
    ...
    backstory:
      "Under the haunting moons of Iskyr, the Lunar Prowl defends the ancient forests from invaders and trespassers. Varnyx, the fiercest among them, is not only feared for his brute strength but for his unparalleled stealth. Legends speak of him moving so quietly, even the wind holds its breath.\r\n\r\nOnce a lone guardian of the hollowed crescent groves, Varnyx now prowls the galaxies, tracking those who defile sacred grounds. His glowing eyes are the last thing many see before the shadows swallow them whole.\r\n\r\nHe speaks little. His presence is command enough.",
    abilities: ["Moonveil Ambush", "Crescent Claw", "Howl of Iskyr"],
    clothingStyle:
      "Scrap-armored hide with rusted metallic shoulder plates and bone-threaded utility belts",
    featured: false,
    inStock: true,
  },
  {
  ...
  },
  {
    ...
    abilities: ["Pyroclastic Barrage", "Synthetic Blaze Aura", "Core Ignition"],
    featured: false,
    inStock: true,
  },
  {
  ...
  },
  {
    ...
    abilities: ["Arc Flux", "Radiant Pulse", "Static Shielding"],
    featured: false,
    inStock: true,
  },
  {
...
const testUserData = {
  ...
  lastName: "User",
  isAdmin: false,
  wishlist: ["687fcf75dca49ea26df92e7b", "687fcf75dca49ea26df92e7d"],
  password: "test123456",
};
...
export const seedDatabase = async () => {
  try {
    ...
    console.log(
      `   - ${1 + 1 + additionalUsers.length} users preserved/created`
    );
